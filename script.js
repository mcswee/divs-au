...
function loadMapLayer() {
    ...
    <div style="border-top: 5px solid ${data.colour || '#ccc'}; padding: 5px; min-width: 160px;">
        ...
        <div style="margin-top: 10px; padding-top: 8px; border-top: 1px solid #eee;">
            ...
            <span style="background: white; color: ${data.colour || '#333'}; padding: 2px 8px; border-color: ${data.colour || '#333'}; border-width: 1.5px; border-radius: 12px; font-size: 10px; font-weight: bold; display: inline-block;">
