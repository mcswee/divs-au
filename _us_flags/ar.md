...
compare: true
critique: |
  There is a half-decent flag hidden here, but the big ol' name tag, thinly veiled, abd outright Confederate references, and the generic red, white, and blue palette turn it into a big mess. 
description: |
